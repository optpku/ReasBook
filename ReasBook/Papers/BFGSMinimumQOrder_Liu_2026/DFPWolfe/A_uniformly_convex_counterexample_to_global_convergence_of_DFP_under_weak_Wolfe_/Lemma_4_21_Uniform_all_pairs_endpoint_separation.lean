...
/- Lemma 4.21 (Uniform all-pairs endpoint separation): every flattened endpoint
is separated from all other endpoints and the limiting circle by a uniform
positive multiple of the squared scale of its cycle. -/
