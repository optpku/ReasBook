...
This leaf module discharges Claim 2 of Supporting Lemma unconditionally, using the verified
...
/-- Supporting fact: the verified unconditional scalar second-scale stationarity packages into
...
/-- Supporting fact: the eventual bundled second scale jet of the transverse derivative family
...
/-- Supporting Lemma (Near-return winding number is nonzero), Claim 2: the transverse
