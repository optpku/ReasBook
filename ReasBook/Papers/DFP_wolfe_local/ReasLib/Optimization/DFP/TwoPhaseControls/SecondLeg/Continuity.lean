...
/-- Supporting fact: the first spectral factors at the canceled base point. -/
...
/-- Supporting fact: the first gradient factors at the canceled base point. -/
...
/-- Supporting fact: continuity of the first spectral factor map at the base. -/
...
/-- Supporting fact: continuity of the first gradient factor map at the base. -/
...
/-- Supporting fact: the three metric entries used by the low frame. -/
...
/-- Supporting fact: continuity of the assembled metric entries. -/
...
/-- Supporting fact: the assembled metric entries at the canceled base. -/
