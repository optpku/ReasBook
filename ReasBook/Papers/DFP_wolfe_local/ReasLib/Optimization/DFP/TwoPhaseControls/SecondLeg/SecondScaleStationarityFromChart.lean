...
/-- Supporting infrastructure: a zero scalar second iterated derivative is equivalent to a
...
/-- Supporting infrastructure: a flat scale-chart certificate packages the component germs and
...
/-- Supporting infrastructure: the proposition that a flat scale chart exists at a transverse
...
/-- Supporting infrastructure: analyticity of the low-gradient factor supplies the `C³` regularity
...
/-- Supporting infrastructure: the flat chart's vanishing quadratic coefficient gives the pure
...
/-- Supporting infrastructure: an eventual family of flat scale charts transports to the scalar
