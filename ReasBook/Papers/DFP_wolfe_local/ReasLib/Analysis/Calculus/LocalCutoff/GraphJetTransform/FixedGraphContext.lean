...
/-- Supporting infrastructure: a finite family of compact-uniform linear branch bounds
...
/-- Supporting fact: a strict bounded-section contraction turns a
...
/-- Supporting fact: an operator residual and a translated secant
...
/-- Supporting infrastructure: a fixed graph context records the contracted top-section
...
/-- Supporting infrastructure: the fixed section stored in a graph context is the
...
/-- Supporting fact: the secant certificate in a fixed graph
...
/-- Supporting fact: the secant certificate makes the scalar predecessor
...
/-- Supporting infrastructure: a fixed graph context projects to the generic
...
/-- Supporting infrastructure: the projected holonomic top-section data supplies
...
/-- Supporting infrastructure: a fixed graph context closes to the holonomic
...
/-- Supporting infrastructure: the fixed graph context simultaneously supplies
...
/-- Supporting infrastructure: an orderwise family of fixed graph contexts upgrades a
...
/-- Supporting infrastructure: after the orderwise bootstrap, every supplied fixed
...
/-- Supporting infrastructure: an orderwise family of fixed graph contexts projects
