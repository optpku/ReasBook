...
Many ReasBook projects are initialized with M2F and then checked and refined
in Lean. M2F and Quokka have complementary roles:
...
| Formalization | Source | Contributors | Resources |
| --- | :---: | --- | --- |
| **[A Counterexample to Global Convergence of Classical DFP Under the Standard Strong Wolfe Conditions](ReasBook/Papers/DFP_wolfe_local/)**<br><sub>Benqi Liu, Zichen Wang, Zaiwen Wen, Liwei Zhang, and Yaxiang Yuan</sub> | [`v4.32.0`](https://github.com/optpku/ReasBook/tree/v4.32.0/ReasBook/Papers/DFP_wolfe_local/) | Zichen Wang | [Docs](https://optpku.github.io/ReasBook/sites/dfp_wolfe_local/docs/) &#124; [Verso](https://optpku.github.io/ReasBook/sites/dfp_wolfe_local/pages/) &#124; [Theorem map](https://optpku.github.io/ReasBook/theorem-maps/papers/dfp_wolfe_local/) &#124; [arXiv](https://arxiv.org/html/2608.21708v1) |
